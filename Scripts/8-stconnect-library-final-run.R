...
## April 16, 2024
##
## This script generates the stconnect library for the project's final model run
...
stconnectLibrary <- ssimLibrary(
  name = file.path(libraryDir, 
                   "a311-stconnect-final-run-30-April-2024.ssim"),
...
# 2010-2070, 40 iterations
targetScenario <- edit_subscenario(
  scenarioName = "Run Control: Spatial; 2010 - 2070; 40 iterations",
  scenarioInput = "Run Control - 40 iterations 60 timesteps.csv",
...
# Datasheet: States
targetScenario <- edit_subscenario(
  scenarioName = "Transition Pathways: LULC; TST Min 30",
  scenarioInput = "Transition Pathways - States - No climate.csv",
  scenarioDatasheet = "stsim_DeterministicTransition")
# Datasheet: Transitions
targetScenario <- edit_subscenario(
  scenarioName = "Transition Pathways: LULC; TST Min 30",
  scenarioInput = "Transition Pathways - Transitions - No climate.csv",
...
targetScenario <- edit_subscenario(
  ...
  scenarioInput = "Output Options - No age.csv",
  scenarioDatasheet = "stsim_OutputOptions")
# Datasheet: Spatial
targetScenario <- edit_subscenario(
  scenarioName = "Output Options",
  scenarioInput = "Output Options Spatial - 60 years.csv",
  scenarioDatasheet = "stsim_OutputOptionsSpatial")
# Datasheet: Spatial Averages
targetScenario <- edit_subscenario(
  scenarioName = "Output Options",
  scenarioInput = "Output Options Spatial Averages - Empty.csv",
...
# 08 Time Since Transition --------

# Create nested sub-folder
tstFolder <- folder(stconnectProject,
                    folder = "08 Time Since Transition",
                    parentFolder = landscapeChangeFolder)

# Create & edit sub-scenario
# Datasheet: Group
targetScenario <- edit_subscenario(
  scenarioName = "Time Since Transition: No Climate; 30",
  scenarioInput = "Time Since Transition Group - No climate.csv",
  scenarioDatasheet = "stsim_TimeSinceTransitionGroup")
# Datasheet: Randomize
targetScenario <- edit_subscenario(
  scenarioName = "Time Since Transition: No Climate; 30",
  scenarioInput = "Initial TST Randomize - No Climate.csv",
...
coreDependencies <- c(20, 19, 18, 17, 16, 15, 14, 8, 7, 4, 3, 2, 1)

# Agnostic
targetScenario <- create_fullscenario(
  scenarioName = "Agnostic, Historic",
  destinationFolder = fullScenarioFolder,
