...
stconnectLibrary <- ssimLibrary(
  name = file.path(libraryDir, 
                   "a311-stconnect-deliverable2-16Feb2024.ssim"),
...
juliaConfiguration <- data.frame(Filename = "C:\\Users\\Administrator\\AppData\\Local\\Programs\\Julia-1.10.1\\bin\\julia.exe")
